 ...
 */
package com.forest.forestchat.util
...
import com.forest.forestchat.common.util.extensions.versionCode
...
class Preferences @Inject constructor(
    ...
    fun theme(
        recipientId: Long = 0,
        default: Int = rxPrefs.getInteger("theme", 0xFF196051.toInt()).get()
    ): Preference<Int> {
        return when (recipientId) {
            0L -> rxPrefs.getInteger("theme", 0xFF196051.toInt())
